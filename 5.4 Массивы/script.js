...
// let fruits = ["Яблоко", "Апельсин", "Слива", "Арбуз"];
// fruits[2] = 'Груша'; // changed
// fruits[3] = 'Лимон'; //added
...
//     let fruits = ["Яблоко", "Апельсин", "Груша", "Арбуз"];
//
...
// fruits.push("Дыня");
// alert(fruits);
// alert( fruits.length ); // Яблоко, Апельсин, Груша
...
//
// fruits.unshift('Яблоко', "Банан", 'Арбуз');
//
...
//
// arr.push("Груша", "Огурец"); // массив меняется по ссылке
...
//     }
// };
// alert(fruits.length); //128
// Об
// ратите внимание, что обычно мы не используем массивы таким образом.
//
